...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-F2ZEXLIO.js";
import "./chunk-TECTLJEV.js";
import "./chunk-C4YQ76F3.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-IJIALHEJ.js";
import {
  DismissableLayer,
  Portal,
  useId
} from "./chunk-KHEXDSEQ.js";
import {
  Presence,
  composeEventHandlers,
  useControllableState
} from "./chunk-ML7TVV52.js";
import {
  useCallbackRef
} from "./chunk-DEFG3XGQ.js";
import "./chunk-COYGYG3U.js";
import {
  composeRefs,
  useComposedRefs
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React9.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime10.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React12.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime13.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React12.isValidElement(newElement) ? React12.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React12.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime16.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime16.jsx)(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime17.jsx)(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: (0, import_jsx_runtime17.jsx)(Root3, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
...
var DropdownMenuArrow = React16.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime17.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
